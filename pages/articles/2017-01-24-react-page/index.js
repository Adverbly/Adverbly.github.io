          ...
          <div className="text">
            ...
            <div id="content">
              ...
              <p>If you kept trying you should have been able to figure out a way to do it by combining both actions. So
                ...
                possibilities. It is clear that there is more structure to this that we can uncover. Let's simplify again
              ...
              <p>is the same as</p>
              <BlockComputationSingle associative={false} commutes={false}
                                      initComputation={[[[[[[[[5, 2], 2], 1], 1], 1], 3], 3], 4]}/>
              ...
              <BlockComputationSingle associative={true} commutes={false}
                                      initComputation={[[[[[[[[4, 1], 3], 2], 5], 2], 1], 2], 3]}/>
              <p>is the same as</p>
              <BlockComputationSingle associative={false} commutes={false}
                                      initComputation={[[4, 1], [3, 2], [[5, 2], [[1, 2], 3]]]}/>
              ...
              <p>Neat! Okay how about the commutative property?
                ...
                In other words, for a commutative function,</p>
              <BlockComputationSingle associative={false} commutes={false}
                                      initComputation={[4, 5, 6, 7, 8, 9, 10, 11, 12]}/>
              <p>is the same as</p>
              <BlockComputationSingle associative={false} commutes={false}
                                      initComputation={[9, 10, 11, 4, 5, 6, 7, 8, 12]}/>
              <p>This makes it a bit harder to pin down. Within each group it is possible to compress it down to a count
                of each
                argument value, similar to what we did with both properties present, but we fall short this time of
                being able to reuse one argument count count across all groups. Even more disappointing about
                commutativity, </p>
            </div>
          </div>
        </div>
